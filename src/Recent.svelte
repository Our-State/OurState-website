<script lang="ts">
  ...
  const apiUrl =
    "https://api.legiscan.com/?key=63420fa619819847e354e0203c6581a5&op=getSearch&query=status:passed&state=NJ"; // Replace 'YOUR_API_ENDPOINT' with the actual LegiScan API URL
